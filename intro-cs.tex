...
This thesis addresses the research questions outlined in Section \ref{sec:research-questions} by exploring binary analysis techniques and the tools commonly used for analyzing software executables. Following this, a deep dive into categorizing the discovered changes based on functionality defined as relevant, and the method to perform this is considered the most effective. Ultimately, the research seeks to determine how changes in software applications impact the forensic analysis process and whether these methods can effectively identify significant alterations. 
...
The thesis does not introduce specific forensic methods or tools utilized during the analysis process. Instead, it assumes that the tools are functional and relevant to the core operations of the examined software.
...
The presented findings can be effectively used to determine if manual reverse engineering software applications are needed before applying a forensic analysis. The main contributions of this thesis are to provide: 
