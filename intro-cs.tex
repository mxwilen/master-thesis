...
This thesis aims to develop a novel method for automating version comparison and categorization of relevant changes for use during reverse engineering of software applications in a targeted forensic analysis.
...
Presented findings can be effectively used to determine if manual reverse engineering software applications are needed before applying a forensic analysis. The main contributions of this thesis are to provide: 
