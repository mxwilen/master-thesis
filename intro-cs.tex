...
Because of this, conducting a full analysis of every version of all relevant applications would entail an unreasonable amount of work. As described by the thesis client, without knowledge of the relevant changes between two software releases, forensic work becomes an ad hoc process in which all differences must be investigated, rather than focusing on those relevant to the forensic investigation. By categorizing changes and filtering them based on their relevance to the forensic investigation, a decrease in the time needed to analyze a single release of an application could be possible.
