...
\begin{rqs}
    From the discussion in Section \ref{sec:discussion-results}, in tandem with the descriptive presentation of the approach found in Section \ref{sec:method:categorization}, we can conclude how to effectively categorize and rank detected changes without having access to source code. Because of this, research question \textit{\#2} can be answered. See Chapter \ref{cha:conclusion} for the full answer.
\end{rqs}
