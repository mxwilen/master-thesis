...
\begin{explanation}
    ...
    \begin{enumerate}
        \item \textbf{bortsollande av non-kritiska är bra} - effektivare granskning
...
\subsection{bortsollande av non-kritiska är bra}
...
...
\textbf{TODO:} I don't think the pipeline works on stripped binaries. look into this further and eventually write about it here.
