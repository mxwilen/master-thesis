...
\subsubsection{Changes to Categorize}
...
%%%% Commented because this way of working with synthetic methods hasn't been developed
...
%%%%% Commented because the discussion doesn't really dig deep into this
...
\begin{figure}
    ...
    \caption{Screenshot of HTML output from the pipeline, executed on two versions of Signal (Android) binaries}
...
As mentioned in the methodology Section \ref{sec:method:overview} \textit{Overview}, the tool developed in this thesis is a pipeline leveraging the binary comparison functionality of Ghidriff. In this section, a technical overview of the implemented pipeline is described.
