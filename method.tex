...
In Figure~\ref{fig:ghidriff_diagram}, an in-depth visualization of how Ghidriff is constructed is presented, and in Figures~\ref{fig:ghidriff_json_output_A},~\ref{fig:ghidriff_json_output_B},~and~\ref{fig:ghidriff_json_output_C}, a visual example of the JSON output can be seen.
