...
\begin{description}
    ...
    \item[Synthetic methods] Compiler-generated methods internally access private class properties. These methods are automatically created at compile time and do not exist in the source code. Because of this, it is reasonable to deprioritize analyzing the functionality of synthetic methods due to the functionality not directly reflect the code written by the developer. However, since it is compiler-generated, a synthetic method can indirectly indicate how a developer's written function operates.
\end{description}
...
Ghidra \cite{ghidra_official} is an open‑source, full‑featured framework for binary reverse engineering that provides architecture‑agnostic capabilities for disassembly, decompilation, and metadata extraction.
