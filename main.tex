...
\declaretheoremstyle[
    headfont=\color{correct_color},
    numbered=no,
    mdframed={
        linewidth=2pt,
        rightline=false, topline=false, bottomline=false,
        linecolor=correct_color, 
        backgroundcolor=weak_correct_color,
    },
]{thmrqsbox}
\declaretheorem[style=thmrqsbox, name=Research question answered]{tmprq}
\newenvironment{rqs}[1][]{\vspace{0pt}\begin{tmprq}}{\end{tmprq}}
...
\titleenglish{A Novel Automated Binary Analysis Framework for Detecting Forensic-Relevant Changes in Android Applications}

%Novel Differential Analysis of Android Binaries: Detecting, Categorizing, and Evaluating Version Changes}
...
\titleswedish{Ramverk för automatisk detektering av forensiskt relevanta ändringar i Android-binärer}


\thesissubject{Datateknik}

\publicationyear{25}
\currentyearthesisnumber{057}
