...
% OLD
%Automated binary analysis %for uncovering core %operational differences in %software executables

\subtitleenglish{Efficiently detect and categorize Android application changes}
