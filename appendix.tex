...
\begin{table}[H]
  ...
  \end{tabular}
  \caption{Keywords used for noncritical categories in the regex patterns.}
...
\begin{table}[H]
  ...
  \begin{tabular}{@{} l l l l l l @{}}
    ...
    verify         & keygen            &              &                &            & \\
                  ...
                  & sha512            &              &                &            & \\
                  & signature         &              &                &            & \\
                  & spongycastle      &              &                &            & \\ \bottomrule
  \end{tabular}
  \caption{Keywords used for critical categories in the regex patterns.}
